...
namespace SSSP.DAL.Migrations
{
    ...
    [Migration("20251127160843_v3-face-ai")]
    partial class v3faceai
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSSP.DAL.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SSSP.DAL.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SSSP.DAL.Models.FaceProfile", b =>
                {
                    b.HasOne("SSSP.DAL.Models.User", "User")
            ...
            modelBuilder.Entity("SSSP.DAL.Models.Incident", b =>
                {
                    b.HasOne("SSSP.DAL.Models.User", "AssignedToUser")
                        .WithMany()
